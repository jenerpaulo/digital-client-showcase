            ...
            <Card className="shadow-xl border-2 border-purple-200 dark:border-purple-700 dark:bg-slate-800">
              ...
              <CardContent className="p-6">
                <p className="text-gray-600 dark:text-gray-300 text-base mb-4">
                  ...
                  presente em nossa nova rede, a Católicos Online. Veja exemplo da página <a href="https://catolicos.online/pages/DivinoAmor/products" target="_blank" style="color: blue;">aqui.</a>
